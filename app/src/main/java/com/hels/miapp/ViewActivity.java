...
public class ViewActivity extends AppCompatActivity {
    ...
    private FloatingActionButton tambahMhs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tambahMhs = findViewById(R.id.btn_add_mhs);
        tambahMhs.setOnClickListener(view -> {
            startActivity(new Intent(ViewActivity.this, MhsActivity.class));
        });
